...
public interface ServiceRemote {
	...
	public abstract Categorie getCategorieById(int id) throws ServiceException;
	...
	public abstract Piece getPieceById(int pieceId) throws ServiceException;
	public abstract void updatePiece(Piece piece) throws ServiceException;
	...
	public abstract Set<Commande> commandeGetByUtilisateur(Utilisateur util) throws ServiceException;
	public abstract void modifierUtilisateur(Utilisateur util) throws ServiceException;
	...
	public abstract Adresse getAdresseById(int adresseId) throws ServiceException;
